...
- Fix integration tests in python 3.14.
...
- Update fonttols and pillow dependencies to fix security vulnerabilities.
- Update documentation to be hosted on readthedocs.io.
- Update minimum compatible Python version to 3.11.
